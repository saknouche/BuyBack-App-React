...
export type DetailsSpectacleTicketProps = {
   ticketData: SpectacleTicketResponse | undefined;
}

const DetailsSpectacleTicket = ({ticketData}: DetailsSpectacleTicketProps) => {
...
export default DetailsSpectacleTicket;
